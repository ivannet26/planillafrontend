  ...
  onSave() {
    if (this.parametroGeneralForm.valid) {
      this.confirmationService.confirm({
        ...
        accept: () => {
          const newParametroGeneral: ParametroGeneral =
            this.parametroGeneralForm.value;
          this.parametroGeneralService
            .CrearParametroGeneral(newParametroGeneral)
            .subscribe({
              next: () => {
              ...
              error: (err) => {
                verMensajeInformativo(
                  ...
                  'Error',
                  err.message ||
                    'Ya existe un registro con ese código y empresa'
                );
              },
            });
        },
