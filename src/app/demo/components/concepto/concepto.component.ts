...
export class ConceptoComponent implements OnInit {
  ...
  nuevoConcepto() {
    ...
    this.conceptoForm.reset({
      ...
      afectacionesSunat: [
        {
          codigo: '01',
          descripcion: 'ESSALUD SEGURO REGULAR TRABAJADOR',
          valor: false,
        },
        ...
        {
          codigo: '08',
          descripcion: 'SISTEMA NACIONAL DE PENSIONES 19990',
          valor: false,
        },
        {
          codigo: '09',
          descripcion: 'SISTEMA PRIVADO DE PENSIONES',
          valor: false,
        },
        {
          codigo: '10',
          descripcion: 'RENTA 5TA CATEGORÍA RETENCIONES',
          valor: false,
        },
        {
          codigo: '15',
          descripcion: 'FONDO COMPLEMENTARIO DE JUBILACIÓN MINERA',
          valor: false,
        },
      ],
      afectacionOtros: [
        ...
        { codigo: '17', descripcion: 'CTS 6 ULTIMAS REM', valor: false },
        {
          codigo: '20',
          descripcion:
            'INGRESOS VARIABLES PROMEDIO (VAC,GRA,CTS,5TA PROYECCION)',
          valor: false,
        },
        {
          codigo: '21',
          descripcion: 'INGRESOS EXTRAORDINARIOS PARA 5TA CATEGORIA',
          valor: false,
        },
      ],
      planillasAsignadas: [
        ...
        {
          codigo: '16',
          descripcion: 'Planilla Gratificaciones ley',
          valor: false,
        },
        ...
        {
          codigo: '20',
          descripcion: 'Planilla Quincenal Adelanto',
          valor: false,
        },
      ],
      regimenesLaborales: [
        ...
        {
          codigo: '16',
          descripcion: 'MICROEMPRESA D. LEG. 1086 (1)',
          valor: false,
        },
        {
          codigo: '17',
          descripcion: 'PEQUEÑA EMPRESA D. LEG. 1086 (1)',
          valor: false,
        },
  ...
  actualizarTipoCalculo(event: any): void {
    const codigoSeleccionado = event.value;
    const tipoSeleccionado = this.tiposCalculo.find((tipo) => tipo.codigo === codigoSeleccionado);

    if (tipoSeleccionado) {
      this.conceptoForm.patchValue({
        calculotipodesc: tipoSeleccionado.descripcion,
      });
    }
  }
  ...
  actualizarConceptoTipo(event: any): void {
    const codigoSeleccionado = event.value;
    const conceptoSeleccionado = this.conceptosTipo.find((concepto) => concepto.codigo === codigoSeleccionado);

    if (conceptoSeleccionado) {
      this.conceptoForm.patchValue({
        conceptotipodesc: conceptoSeleccionado.descripcion,
      });
    }
  }
  ...
  subTiposConcepto: SubTipoConcepto[] = [
    ...
    { conceptoTipoCod: '07', codigo: '07', descripcion: 'Aportes' },
  ];

  actualizarSubTipoConcepto(event: any): void {
    const codigoSeleccionado = event.value;
    const subtipoSeleccionado = this.subTiposConcepto.find((subtipo) => subtipo.codigo === codigoSeleccionado);

    if (subtipoSeleccionado) {
      this.conceptoForm.patchValue({
        conceptosubtipodesc: subtipoSeleccionado.descripcion,
      });
    }
  }
  ...
  conceptosSunat: ConceptoSunat[] = [
    ...
    {
      codigoSunat: '0104',
      descripcion: 'COMISIONES EVENTUALES A TRABAJADOR...',
    },
    {
      codigoSunat: '0105',
      descripcion: 'TRABAJO EN SOBRETIEMPO (HORAS EXT...',
    },
    {
      codigoSunat: '0106',
      descripcion: 'TRABAJO EN SOBRETIEMPO (HORAS EXT...',
    ...
    {
      codigoSunat: '0107',
      descripcion: 'TRABAJO EN DÍA FERIADO O DÍA DE DES...',
    },
    {
      codigoSunat: '0803',
      descripcion: 'PÓLIZA DE SEGURO - D. LEG. 688',
    },
    {
      codigoSunat: '0807',
      descripcion: 'SENATI',
  ...
  actualizarConceptoSunat(event: any): void {
    const codigoSeleccionado = event.value;
    const sunatSeleccionado = this.conceptosSunat.find((sunat) => sunat.codigoSunat === codigoSeleccionado);

    if (sunatSeleccionado) {
      this.conceptoForm.patchValue({
        conceptosunatdesc: sunatSeleccionado.descripcion,
      });
    }
  }
  ...
  seleccionarConceptoEstandar(concepto: {
    codigo: string;
    descripcion: string;
  }): void {
    this.conceptoForm.patchValue({
